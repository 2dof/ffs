...
#        print(self.fis1.NRules)
    ...
    def test_add_del_mf(self):
        ...
        self.assertListEqual(list(self.fis1.mfnames_in),['A1', 'A2', 'A3','A4', 'B1', 'B2', 'B3'])
    ...
    def test_add_del_rule(self):
        ...
        self.assertEqual(self.fis1.NRules,3)
        #print(self.fis1.RuleList[0])
        self.assertListEqual(list(self.fis1.RuleList[0]),[1,1,1,1,])
        self.assertListEqual(list(self.fis1.RuleWeights),[1.,1.,1.])
        
        self.fis1.addrule([1,2,3,0],.5)  # if A1 or B2 then C3 , weiht 0.5 
        self.assertEqual(self.fis1.NRules,4)
        self.assertListEqual(list(self.fis1.RuleList[3]),[1,2,3,0])
        self.assertEqual(self.fis1.RuleWeights[3],0.5)
